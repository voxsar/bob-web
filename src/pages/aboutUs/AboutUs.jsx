...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <div className="ajourny-section">
        <Row>
          <Col>
            <div className="ajourny-img">
              <img
                loading="lazy"
                decoding="async"
                width="88%"
            ...
            <div className="ajourney-paragraph">
              ...
              <div>
                <div className="paragraph-content">
                  <p>
                    Nestled in the historic downtowns of Little Falls and St.
              ...
              <div>
                <div className="paragraph-content">
                  <p>
                    Adelle &#8217;s venture into motherhood was more than just a
                    life change; it was an eye-opener. It revealed the
                    challenges of finding quality, practical baby products in
                    Central Minnesota. But more than that, it exposed the need
                    for a space where the unspoken aspects of parenting are
              ...
              <div>
                <div className="paragraph-content">
                  <p>
                    ...
                    Certified Passenger Safety Technician, Adelle ensures that
                    safety is a priority, but she also knows that parenting is
                    about learning, adapting, and sometimes, just making it
                    through the day.
                  </p>
                </div>
              </div>
      ...
      <div className="acommunity-section">
        <Row>
          <Col>
            <div className="acommunity-paragraph">
              <div className="elementor-widget-wrap elementor-element-populated">
                ...
                <div>
                  <div className="paragraph-content">
                    <p>
                      Our boutique has grown into a vibrant community hub, a
                      place where laughter and tears are equally welcome.
                      Whether you &#8217;re navigating the early days of
                      motherhood, juggling the demands of toddlerhood, or simply
                      seeking a moment of solidarity, our doors are open. Our
                      baby registry, cozy baby shower space, and personalized
                      consultations are more than services – they &#8217;re
                      extensions of our belief in supporting and celebrating
                      every aspect of parenthood.
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div>
                  <div className="paragraph-content">
                    <p>
                      At Baby &#8217;s on Broadway, you &#8217;re not just
                      stepping into a store; you &#8217;re joining a family that
                      believes in the beauty of being real. We invite you to
                      share in our journey, find comfort in our stories, and
                      experience the authenticity that makes parenting an
          ...
          <Col>
            <div className="rolling-paragraph">
              ...
              <div>
                <div className="paragraph-content">
                  <p>
                    In our continuous journey to embrace and share the
                    unvarnished truths of parenthood, Baby &#8217;s on Broadway
                    proudly extends its narrative through Adelle &#8217;s
                    podcast, &#8220;Rolling in the Deep.&#8221;This podcast
                    series is more than just an extension of our store; it
                    &#8217;s a candid, heart-to-heart conversation about the
                    joys, challenges, and everything in between that comes with
                    parenting.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="paragraph-content">
                  <p>
                    Each episode of &#8220;Rolling in the Deep &#8221;delves
                    into topics that are often left unspoken. From discussing
                    the complexities of parenting a child with trauma to
                    debunking common myths about car seats, the podcast offers a
                    space for honest dialogue. Adelle, alongside various guests,
                    explores the depths of parenting experiences, offering
                    insights, advice, and a comforting voice to parents
                    navigating this beautiful yet challenging journey. The
                    podcast embodies our belief that sharing real stories and
                    experiences can empower and support parents in a way that
                    goes beyond the physical products we offer.
                  </p>
                </div>
              </div>
              <div>
